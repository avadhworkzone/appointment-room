      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Text(
                widget.reservation.fullname,textAlign: TextAlign.center,
            ...
            _buildInfoRow(Icons.calendar_today, "Check-in: ${widget.reservation.checkin}"),
            _buildInfoRow(Icons.calendar_today, "Check-out: ${widget.reservation.checkout}"),
            SizedBox(height: 16),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _buildGuestCount(Icons.person, "Adults", widget.reservation.adult),
                _buildGuestCount(Icons.child_care, "Children", widget.reservation.child),
            ...
            _buildPriceRow("Grand Total", widget.reservation.grandTotal, isBold: true),
            ...
            child: Row(
              children: [
                Expanded(
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Center(child: Text('Back',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),),
                    ),
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: InkWell(
                    onTap: () async{
                      await showReservationDialog(reservation: widget.reservation)  ;
                    },
                    child: Container(
                      decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(30),border: Border.all(color: Colors.grey,width: 1),
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(20),
                      child: Center(child: Text('Edit',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),),
                    ),
                    ),
                  ),
                ),
